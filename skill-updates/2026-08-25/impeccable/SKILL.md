...
- **Operate lifecycle rule:** establish the canonical durable entity and business-event sequence before arranging controls. Provide one obvious write path per event, remove or demote legacy duplicates in the same pass, and keep specialized screens as views of the canonical lifecycle rather than separate status systems.
