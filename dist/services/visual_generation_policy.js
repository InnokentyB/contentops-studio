...
exports.assertVisualGenerationGate = assertVisualGenerationGate;
exports.hardenEditorialVisualPrompt = hardenEditorialVisualPrompt;
function assertVisualGenerationGate(input) {
...
function hardenEditorialVisualPrompt(prompt) {
    return `${prompt.trim()}
