...
function inferManualResourceKind(fileName: string, mimeType?: string | null) {
...
function readMultipartField(field: any) {
...
async function resolveOwnedOrganizationId(userId: number, requestedOrganizationId?: number) {
...
export default async function projectRoutes(fastify: FastifyInstance) {
    ...
    fastify.post('/api/projects', async (request, reply) => {
        const user = (request as any).user;
        const { name, slug, description, kind, organizationId } = request.body as any;
    ...
    fastify.get('/api/projects/:id/mcp/status', async (request, reply) => {
        ...
        try {
            ...
            const capabilityStatus = (profile: 'planner' | 'writer' | 'art_director' | 'strategist' | 'organization_researcher') => {
