...
const messages: Record<Locale, Messages> = {
  en: {
    ...
    openOverview: 'Open overview', openNavigation: 'Open navigation', closeNavigation: 'Close navigation',
  ...
  ru: {
    ...
    openOverview: 'Открыть обзор', openNavigation: 'Открыть навигацию', closeNavigation: 'Закрыть навигацию',
